...
public class StartWindow2 extends JFrame {
    ...
    private JButton bSpeichernSchliessen = new JButton();
    // Ende Attribute
    ...
    public StartWindow2() {
        ...
        bSpeichernSchliessen.setBounds(250, 350, 200, 60);
        bSpeichernSchliessen.setText("Speichern/Schließen");
        bSpeichernSchliessen.setMargin(new Insets(2, 2, 2, 2));
        bSpeichernSchliessen.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                bSpeichernSchliessen_ActionPerformed(evt);
            }
        });
        bSpeichernSchliessen.setFont(new Font("Dialog", Font.BOLD, 15));
        cp.add(bSpeichernSchliessen);
        // Ende Komponenten
    ...
    public void bSpeichernSchliessen_ActionPerformed(ActionEvent evt) {
        // TODO hier Quelltext einfügen

    } // end of bSpeichernSchliessen_ActionPerformed
